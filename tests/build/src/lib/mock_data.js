...
exports.DEFAULT_MOCK_DATASET = exports.MOCK_DATASETS = void 0;
exports.getRandomMockDataset = getRandomMockDataset;
exports.MOCK_DATASETS = [
    {
...
exports.DEFAULT_MOCK_DATASET = exports.MOCK_DATASETS[0];
function getRandomMockDataset(currentId) {
    const pool = currentId ? exports.MOCK_DATASETS.filter(ds => ds.id !== currentId) : exports.MOCK_DATASETS;
    const base = pool.length ? pool : exports.MOCK_DATASETS;
