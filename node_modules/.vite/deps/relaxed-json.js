...
var require_relaxed_json = __commonJS({
  "node_modules/relaxed-json/relaxed-json.js"(exports, module) {
    (function() {
      "use strict";
      ...
      function fStringSingle(m) {
        ...
        return {
          ...
          // abusing real JSON.parse to unquote string
        };
      }
      ...
      function parse(text, opts) {
        if (typeof opts === "function" || opts === void 0) {
        ...
        opts.relaxed = opts.relaxed !== void 0 ? opts.relaxed : true;
...
export default require_relaxed_json();
//# sourceMappingURL=relaxed-json.js.map
